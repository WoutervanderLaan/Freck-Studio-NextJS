...
const Services = () => {
    ...
    //         const childDivs = tagContainer.current.getElementsByTagName('div')
    ...
    //         const randomIndex = Math.round(Math.random() * tagPositions.length)
        ...
        >
            ...
            >
                ...
                >
                    {/* {XY && (
                        <motion.span
                            className="w-10 h-10 left-0 top-0 absolute bg-blue border-2 border-black shadow-lg  rounded-full z-30"
                            animate={XY}
                        />
                    )} */}
