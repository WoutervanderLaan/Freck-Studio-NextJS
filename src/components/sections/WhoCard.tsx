        ...
        >
            ...
            <p className="text-blue text-center text-base-variant mt-5 z-10 md:max-w-[70%] lg:max-w-[640px] md:text-base-v2">
                <AriaLink
                    ...
                    rel="external"
                >
                    <q>Ade due Damballa. Give me the power, I beg of you!</q>
                </AriaLink>
                <br />
                <br />
                An exclusive glimpse behind the curtains at Freck. These totems
                hold a vital role, channeling the energies required for
                cutting-edge design in today&apos;s world.
            </p>
            <div className="relative bottom-[-50px] w-[100vw] sm:w-full aspect-desk mt-[-30px] md:mt-[-90px] lg:bottom-[-90px]">
                <video muted loop autoPlay preload="auto" playsInline>
                    ...
                    />
                    <source src="/img/Desk_Chrome_2.webm" type="video/webm" />
